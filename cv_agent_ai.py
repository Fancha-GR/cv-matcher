...
with st.expander("🔒 Πληροφορίες Ασφαλείας / Προστασίας Προσωπικών Δεδομένων", expanded=False):
    st.markdown("""
    ...
    Εάν έχετε ερωτήσεις ή ανησυχίες, μη διστάσετε να επικοινωνήσετε με τον υπεύθυνο της εφαρμογής.
    """)
